        ...
        <footer className="bg-gray-100 text-center">
          <div className="px-6 pt-6">
            <form action="">
              <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
                ...
                <div className="flex flex-row items-center md:justify-center mb-6">
                  <a
                    href="#!"
                    type="button"
                    className="rounded-full border-2 border-blue text-blue leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
                  >
                    <svg
                      aria-hidden="true"
                      focusable="false"
                  ...
                  <a
                    href="https://twitter.com/RRaselane"
                    type="button"
                    className="rounded-full border-2 border-blue text-blue leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/in/refiloe-raselane"
                    type="button"
                    className="rounded-full border-2 border-blue text-blue leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
                  >
                    <svg
                  ...
                  <a
                    href="https://github.com/Raselane"
                    type="button"
                    className="rounded-full border-2 border-blue text-blue leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
                  >
                    <svg
          ...
          <div className="text-center text-gray-700 p-4 bg-[rgba(0, 0, 0, 0.2)]">
            ...
            <a
              ...
              href="https://estore-221122-1.vercel.app"
            >
